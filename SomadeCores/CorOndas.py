...
y(t) = Σ [Aₙ · sin(2π · fₙ · t)]
    ...
    def _frequency_to_rgb(self, freq_thz):
        ...
        wavelength_nm = self._frequency_to_wavelength_nm(freq_thz)
    ...
    def _draw_frequency_color_scale(self, ax):
        ...
        ax.clear()
        ax.set_title('Escala espectral aproximada', fontsize=12, fontweight='bold')
        ...
        ax.set_xlabel('Frequência (THz) na 1ª linha | comprimento de onda equivalente (nm) na 2ª')
    ...
    def _show_visible_colors(self, event):
        ...
        fig_colors.text(0.5, 0.03,
                        'As cores mostradas são aproximações visuais: cada frequência é convertida para um comprimento de onda equivalente e depois combinada por mistura RGB.',
