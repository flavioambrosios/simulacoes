(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '.enhancer-conclusion-guide { margin-top: 10px; padding: 10px 12px; border-radius: 10px; background: rgba(255, 255, 255, 0.06); border: 1px solid rgba(255, 221, 136, 0.28); color: #f8f8f8; font-size: 0.92rem; line-height: 1.4; }',
            '.enhancer-conclusion-guide-title { margin: 0 0 6px; color: #ffdd88; font-weight: 700; }',
            '.enhancer-conclusion-guide p { margin: 0 0 8px; }',
            '.enhancer-conclusion-guide ol { margin: 0 0 8px 18px; padding: 0; }',
            '.enhancer-conclusion-guide li { margin: 0 0 4px; }',
            '.enhancer-conclusion-guide-checklist { margin-top: 8px; padding-top: 8px; border-top: 1px dashed rgba(255, 221, 136, 0.32); }',
            '.enhancer-conclusion-guide-checklist strong { color: #ffdd88; }',
    ...
    function ensureEnhancedFormFields() {
        ...
        emailForm.innerHTML = [
                    ...
                    '<div class="enhancer-conclusion-guide" id="enhancerConclusionGuide">',
                    '<div class="enhancer-conclusion-guide-title">Como escrever uma conclusão nota máxima</div>',
                    '<p>Mostre o que você aprendeu de forma clara, com conceitos da aula, evidências da atividade e aplicação prática.</p>',
                    '<ol>',
                    '<li>Diga o que você entendeu melhor após a atividade.</li>',
                    '<li>Cite os conceitos principais estudados.</li>',
                    '<li>Explique uma relação de causa e efeito (por que acontece e o que isso provoca).</li>',
                    '<li>Mostre o que os cálculos, simulação ou análise revelaram.</li>',
                    '<li>Conecte com uma aplicação prática do cotidiano ou da área técnica.</li>',
                    '<li>Finalize com uma síntese clara do aprendizado.</li>',
                    '</ol>',
                    '<div class="enhancer-conclusion-guide-checklist"><strong>Checklist rápido antes de enviar:</strong> Meu texto está coerente com o tema? Usei os conceitos da aula com minhas palavras? Mostrei evidências do que aprendi na atividade?</div>',
                    '</div>',
                    '</div>',
    ...
    function buildScoreAliasPayload(finalScore, scoreData, aiAnalysis) {
        ...
        return {
            ...
            conclusionScore: normalizedConclusionScore,
            conclusionScoreValue: normalizedConclusionScore,
            exerciseScore: normalizedExerciseScore,
            exerciseScoreValue: normalizedExerciseScore,
            finalScoreValue: normalizedFinalScore,
    ...
    function buildStudentCopyEmailPayload(formData, scoreData, aiAnalysis, finalScore) {
        ...
        const mensagemTexto = [
            ...
            '• Nota da conclusão: ' + Number((aiAnalysis && aiAnalysis.finalScore) || 0).toFixed(1),
            '• Nota final combinada: ' + notaFinalFormatada,
