...
## 💡 Minha Opinião sobre Inclusão de Informações Individuais

Sim, recomendo incluir **duas informações** em cada simulação individualmente:

1. **No `<head>`** de cada HTML, adicione metadados de autoria:

```html
<meta name="citation_title" content="Simulação de [Nome] - Lei de Faraday">
<meta name="citation_author" content="Flávio Ambrósio Campos">
<meta name="citation_publication_date" content="2026">
<meta name="citation_doi" content="10.5281/zenodo.14860563">
<meta name="citation_publisher" content="GitHub Pages">
<meta name="citation_url" content="https://flavioambrosios.github.io/simulacoes/LeideFaraday/">
```

2. **No final de cada simulação**, antes do `</body>`, links para o repositório e DOI:

```html
<footer style="margin-top: 20px; text-align: center; color: rgba(255,255,255,0.5); font-size: 0.8rem;">
    <p>
        Simulação parte do repositório 
        <a href="https://github.com/flavioambrosios/simulacoes" style="color: #ffcc00;">
            Simulações Interativas de Física
        </a> 
        | DOI: <a href="https://doi.org/10.5281/zenodo.14860563" style="color: #ffcc00;">
            10.5281/zenodo.14860563
        </a> 
        | Licença MIT</p>
</footer>
```
...
- **Rastreabilidade:** mesmo que o repositório principal cresça ou mude, cada simulação carrega sua própria referência
- **Uso offline:** se alguém baixar uma simulação isolada, ainda encontrará a informação de autoria e licença
- **Indexação:** o `citation_doi` no `<head>` ajuda mecanismos de busca a associarem cada página ao DOI
- **Boas práticas acadêmicas:** citação explícita em cada página facilita a atribuição por terceiros
- **Estudantes:** ao abrir uma simulação, veem que o material tem registro formal e autoria definida

**Como fazer de forma prática:**

Se quiser, posso adicionar esses metadados em todas as simulações de uma vez — é um trabalho manual pois cada simulação é um HTML independente, mas posso fazer uma busca e adicionar em lote usando um script ou manualmente nas mais importantes.